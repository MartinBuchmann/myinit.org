...
# Time-stamp: <2017-02-20 21:00:24 Martin>
...
**** org-wunderlist
Funktioniert nicht ohne Fehler, deshalb deaktivieren ich es erst einmal wieder.
#+BEGIN_SRC emacs-lisp
...
** YASnippet
Aktuell benötige ich keine Templates.  Vielleicht probiere ich später einmal,
das in meinen Workflow zu integrieren.
  #+BEGIN_SRC emacs-lisp
...
#  LocalWords:  complete Templates Workflow
