...
#+STARTUP: content
#+OPTIONS: toc:nil
# Time-stamp: <2019-01-04 19:36:50 Martin>
...
Ein [[https://github.com/alphapapa/outshine/blob/master/README.org][schlanker Versuch]] von /Literate Programming/. Funktioniert leider aktuell
nicht richtig, deshalb erst einmal deaktiviert.

#+begin_src emacs-lisp
  (use-package outshine
    :disabled t
    :init
    (defvar outline-minor-mode-prefix (kbd "M-x"))
    :config
...
Ich +verwende+ /habe/ [[https://github.com/sharplispers/log4cl/][log4cl]] zur besseren Ausgabe von Statusinformationen usw
verwendet, aber die Emacs-Integration klappt noch nicht. Deshalb deaktiviere ich
das Paket erst einmal wieder.

#+BEGIN_SRC emacs-lisp
;; (load "~/quicklisp/log4slime-setup.el")
;; (global-log4slime-mode 0)
#+END_SRC
...
Ein Interface für [[https://github.com/walseb/blimp][ImageMagick]].
...
#  LocalWords:  link slime Blimp poporg Outshine Literate Programming
