...
#+STARTUP: content
# Time-stamp: <2017-02-10 21:38:30 Martin>
...
Gefunden bei [[https://github.com/hrs/sensible-defaults.el][Harry Schwartz]]
#+BEGIN_SRC emacs-lisp
(load-file "/Users/Martin/.emacs.d/elisp/sensible-defaults.el")
...
#+BEGIN_SRC emacs-lisp
 ...
 (setq org-agenda-files (list "~/Dropbox/orgfiles/Journal.org"
                              "~/Dropbox/orgfiles/Martin.org"
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-capture-templates
        '(("l" "Link" entry (file+headline "~/Dropbox/orgfiles/Links.org" "Links")
           "* %? %^L %^g \n%T" :prepend t)
          ("t" "To Do Item" entry (file+headline "~/Dropbox/orgfiles/Martin.org" "To Do")
           "* TODO %?\n%u" :prepend t)
...
#+BEGIN_SRC emacs-lisp
  ;; Starts a server for connecting from emacsclient
  (server-start)
