(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (zenburn ac-geiser geiser ac-slime memento-mori momento-mori symbol-overlay better-jumper better-jump ivy-youtube mode-icons ivy-posframe parinfer shift-numbers smart-mode-line-powerline-theme sml web-mode dired-rsync ivy-rich dired-sidebar all-the-icons-dired dired-subtree dired-narrow dired+ lv annotate AUCTeX focus counsel-projectile all-the-icons-ivy all-the-icons magit-popup mwim org-tree-slide demo-it magithub outshine magit-todos git-commit zenburn-theme projectile ace-jump-zap mu4e-conversation ivy-prescient auto-complete-auctex ac-ispell ace-link mic-paren define-word helpful ac-emoji cdlatex poporg shift-number org-projectile dashboard linum-relative diminish git-gutter ace-window ace-mc gnuplot dired-details multiple-cursors pdf-tools wc-mode beginend finder+ wgrep f git-timemachine rainbow-mode rainbow-delimiters dired-quick-sort gist osx-dictionary osx-org-clock-menubar mu4e-maildirs-extension mu4e mu4e-alert lorem-ipsum auctex smart-comment org-beautify-theme ac-math org-wunderlist osx-bbdb osx-lib alert readline-complete htmlize org-ac bbdb-handy bbdb org-gcal noflet undo-tree try powerline paredit org-bullets markdown-mode ivy-hydra expand-region exec-path-from-shell counsel beacon avy)))
