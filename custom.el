(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ac-slime ac-ispell auto-complete-auctex ace-link mu4e-conversation mic-paren define-word helpful emms-state emms-mode-line-cycle emms ac-emoji cdlatex poporg shift-number yasnippet-snippets yahoo-weather org-projectile dashboard linum-relative diminish git-gutter ace-window celestial-mode-line ace-mc gnuplot dired-details multiple-cursors pdf-tools wc-mode beginend finder+ wgrep f git-timemachine rainbow-mode rainbow-delimiters nord-theme dired-quick-sort gist web-mode osx-dictionary osx-org-clock-menubar mu4e-maildirs-extension mu4e mu4e-alert lorem-ipsum auctex smart-comment org-beautify-theme zenburn-theme ac-math org-wunderlist osx-bbdb osx-lib alert readline-complete htmlize org-ac counsel-projectile counsel-osx-app bbdb-handy bbdb org-gcal noflet w3m yasnippet which-key use-package undo-tree try powerline paredit org-bullets mode-icons markdown-mode magit ivy-hydra expand-region exec-path-from-shell counsel command-log-mode bm beacon avy)))
